...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_live_6B6FM68dyrGW9tSWtjuvvSNu');
...
if ($_POST) {
  Stripe::setApiKey("sk_live_hnJboY3jqCjkbM5rT1yJEnYp");
  ...
  try {
    ...
    Stripe_Charge::create(array("amount" => $_POST['amount']*100,"currency" => "usd","card" => $_POST['stripeToken'],"description" => $_POST['ref_number'],"email" => $_POST['email'],"receipt_email" => $_POST['email']));
...
?>
  ...
  <!-- Card Holder Name -->
    <div class="form-group">
      <label class="col-sm-4 control-label"  for="textinput">Reference Number</label>
      <div class="col-sm-6">
        <input type="text" name="ref_number" maxlength="7" placeholder="Reference Number" class="form-control">
      </div>
    </div>
  <!-- Email -->
  <div class="form-group">
  ...
  <fieldset>
    ...
    <!-- Card Holder Name -->
    <div class="form-group">
      <label class="col-sm-4 control-label"  for="textinput">Amount (USD)</label>
      <div class="col-sm-6">
        <input type="text" name="amount" maxlength="7" placeholder="Amount" class="form-control">
      </div>
    </div>
